                ...
                {socialMedia?.appleMusic && (
                  <a
                    ...
                    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="white">
                      <path d="M18.7 19.5c-.6.9-1.4 1.6-2.5 2-1.1.5-2.3.7-3.5.7-1.2 0-2.4-.2-3.5-.7-1.1-.4-1.9-1.1-2.5-2-.6-.9-1-1.9-1.2-3-.2-1.1-.1-2.2.3-3.3.4-1.1 1-2 1.9-2.8.9-.8 1.9-1.3 3-1.6 1.1-.3 2.2-.2 3.3.2 1.1.4 2 1.1 2.7 2 .7.9 1.1 2 1.2 3.2.1 1.2-.1 2.3-.5 3.4zm1-6.8c-.5-.6-1.2-1-2-1.2-.8-.2-1.6-.1-2.4.3-.8.4-1.4.9-1.8 1.6-.4.7-.6 1.5-.5 2.3.1.9.4 1.7 1 2.4.6.7 1.3 1.1 2.2 1.3.9.2 1.7.1 2.5-.3.8-.4 1.4-.9 1.8-1.6.4-.7.6-1.4.5-2.2-.1-.8-.4-1.6-1-2.3-.3-.4-.7-.7-1.2-.9-.1-.1-.3-.1-.4-.2zM12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm4.3 16.8c-.4.6-1.1 1-1.9 1.2.6-.7 1-1.6 1.1-2.5.1-.9-.1-1.8-.5-2.6-.4-.8-1-1.5-1.8-2-.8-.5-1.7-.7-2.6-.5-.9.2-1.7.6-2.3 1.3-.6.7-1 1.5-1.1 2.4-.1.9.1 1.8.5 2.6.4.8 1 1.5 1.8 2 .8.5 1.7.7 2.6.5.3-.1.6-.2.9-.4-.7.5-1.5.8-2.4.8-1.3 0-2.5-.5-3.4-1.4-.9-.9-1.4-2.1-1.4-3.4 0-1.3.5-2.5 1.4-3.4.9-.9 2.1-1.4 3.4-1.4 1.3 0 2.5.5 3.4 1.4.9.9 1.4 2.1 1.4 3.4 0 .9-.2 1.7-.7 2.5z" />
                    </svg>
                  </a>
                )}
                {socialMedia?.patreon && (
