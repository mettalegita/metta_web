...
Each gathering takes place in a private home, with a small number of listeners. The intention is simple: to bring music closer. To create an environment where sound can be felt more personally, and where the connection between performer and audience becomes more immediate and human.
